...
![CC Switch 配置界面](/Users/reb00t/workspace/temp/reb00t.github.io/images/cc-switch-config.png)

只需要填写刚才申请的 API Key。注意开启「路由设置」选项：

![路由设置](/Users/reb00t/workspace/temp/reb00t.github.io/images/cc-switch-routing.png)

### 5. 验证连通性

在 Codex 中尝试发起一次对话请求。如果配置正确，Codex 应该能够正常与 DeepSeek 交互。

![验证连通性](/Users/reb00t/workspace/temp/reb00t.github.io/images/codex-verify.png)
